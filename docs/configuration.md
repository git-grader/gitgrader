...
| `security.ldap.url` | `SECURITY_LDAP_URL` | `ldap://localhost:389` | Directory endpoint. `ldaps://` is required under the production profile: the instructor password and the manager bind credentials cross this connection. |
