...
/**
 * Values used to create a course.
 *
 ...
 */
public record CourseDefinition(String courseKey, String name, @Nullable String description, @Nullable String semester,
		@Nullable LocalDate startsOn, @Nullable LocalDate endsOn, String timezone, CourseStatus status,
		@Nullable Instant registrationOpensAt, @Nullable Instant registrationClosesAt, boolean registrationEnabled) {
}
