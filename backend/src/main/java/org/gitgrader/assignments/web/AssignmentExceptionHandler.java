...
/** Maps invalid assignment updates to safe problem documents. */
@RestControllerAdvice(basePackageClasses = AssignmentController.class)
@Order(Ordered.HIGHEST_PRECEDENCE)
public class AssignmentExceptionHandler {

	/**
	 * Renders an attempted assignment identity change as a client error.
